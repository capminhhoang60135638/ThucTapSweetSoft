    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="body">
                ...
                $sql_hoadon="select hd.hoadon_id, cthd.giaodich_date,cthd.tien from hoadon hd JOIN cthoadon cthd WHERE hd.hoadon_id = cthd.hoadon_id";
                    ...
                    <table border="1px;" align="center">
	                    ...
	                    <tbody>
		                    ...
		                    <tr>
			                    ...
			                    <td><?php echo $data['giaodich_date']; ?></td>
			                    ...
			                    <td>
                                    <a href="detailhoadon.php?id_hd=<?php echo $data['hoadon_id']?>">Chi tiết</a>
