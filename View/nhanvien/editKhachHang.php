...
if(isset($_POST['Confirm']))
{
    ...
    $sql_update_kh="UPDATE `khachhang` SET `khachhang_ho`='".$_POST['ho']."',`khachhang_ten`='".$_POST['ten']."',`khachhang_ngaysinh`='".$_POST['ngaysinh']."',`gioi_tinh`=b'".$_POST['gt']."',`khachhang_sdt`='".$_POST['sdt']."',`sodu`='".$_POST['sodu']."' WHERE khachhang_id=".$_GET['id_kh'];
    ...
    $sql_update_lkh="UPDATE `khachhang_loaikh` kh_lkh SET `maloaikh`='".$_POST['lkh']."' WHERE kh_lkh.makh=".$_GET['id_kh'];
   ...
   //update bang tk
     $sql_update_tk="UPDATE `taikhoan` tk SET `password`='".$_POST['pass']."' WHERE ma_khachhang='".$_GET['id_kh']."'";
        ...
        <div id="add">
            <form method="POST" action="" id="form_add">
                ...
                <fieldset>
                    ...
                    <tr>
                        <?php 
                        $sql_tk= "select password from  taikhoan tk where tk.ma_khachhang= '{$_GET['id_kh']}' ";
