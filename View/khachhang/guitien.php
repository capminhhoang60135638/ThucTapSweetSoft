...
session_start();
    ...
    if(isset($_GET['id']))
        ...
        ///tim thông tin của người gửi
        {
           
                
                $sql_info_nguoigui="SELECT * FROM khachhang kh WHERE kh.khachhang_id=".$_GET['id'];
                $data_info_nguoigui=mysqli_fetch_array(mysqli_query($conn,$sql_info_nguoigui));
                $hoten=$data_info_nguoigui['khachhang_ho']." ".$data_info_nguoigui['khachhang_ten'];
                $gt=$data_info_nguoigui['gioi_tinh'];
                $sdt=$data_info_nguoigui['khachhang_sdt'];
    ...
    else if(isset($_POST['Confirm']))
    {
        ...
        if($sodu>$_POST['tien'])
        {
            ...
            //echo $ngaygui;
            $sql_add_hoadon="INSERT INTO `hoadon`(`khgui_id`) VALUES ('".$id_gui."')";
        ...
        //dua vao id cua khach hang de tim thong tin nguoi gui
                    ...
                    <h2>BẢNG CHUYỂN TIỀN</h2>
                        ...
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    <th>Mã người gửi:</th>
                                    <td><input type="search" name="manguoigui" disabled value="<?php if(isset($_GET['id'])) echo $_GET['id']?>"></td>
                                </tr>
                                <tr>
                                    <th>Họ và tên người gửi:</th>
                                    <td>
                                        <input type="text" name="tennguoigui" disabled value="<?php if(isset($hoten)) echo $hoten?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Giới tính:</th>
                                    <td><input type="text" name="gtnguoigui" disabled value="<?php if($gt==1) echo "Nam"; else echo "Nữ"?>"></td>
                                </tr>
                                <tr>
                                    <th>Số điện thoại:</th>
                                    <td><input type="text" name="sdtnguoigui" disabled value="<?php if(isset($sdt)) echo $sdt;?>"></td>
                                </tr>
                        ...
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    <th>Mã người nhận:</th>
                                    <td><input type="search" name="id_nhan" value="<?php if(isset($_POST['id_nhan'])) echo $_POST['id_nhan']?>"><button type="submit" name="search"><i class="fa fa-search"></i></button></td>
                                </tr>
                                <tr>
