...
if(isset($_GET['id']))
{
    ...
    $sql_hd = "select hd.hoadon_id, hd.khgui_id, hd.nhanvien_id, cthd.khnhan_id, cthd.noidung, cthd.giaodich_date,cthd.tien from hoadon hd JOIN cthoadon cthd WHERE hd.hoadon_id = cthd.hoadon_id AND (hd.khgui_id=".$_GET['id']." or cthd.khnhan_id=".$_GET['id'].") and hd.hoadon_id=".$_GET['id_hd'];
