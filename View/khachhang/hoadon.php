    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="body">
                ...
                $sql_hoadon="select hd.hoadon_id, cthd.giaodich_date,cthd.tien from hoadon hd JOIN cthoadon cthd WHERE hd.hoadon_id = cthd.hoadon_id AND (hd.khgui_id=".$_GET['id']." or cthd.khnhan_id=".$_GET['id'].")";
